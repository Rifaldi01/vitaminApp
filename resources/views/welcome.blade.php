        ...
        <div class="row g-2 py-2">
            ...
            <div class="col-md-3 services-wrap d-flex">
                <div class="services color-3">
                    <div class="icon"><span class="flaticon-furniture"></span></div>
                    <div class="text">
                        <h2>Modern Design</h2>
                        <p class="mb-0">Far far away, behind the word mountains, far from the countries Vokalia.</p>
                    </div>
...
<section class="ftco-section bg-light ftco-no-pt">
    <div class="container">
        ...
        <div class="row justify-content-center g-0">
            <div class="col-md-4 text-center d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100"
                 data-aos-duration="1000">
                <div class="flow-wrap flow-wrap-right">
                    <div class="icon">
                        <div class="d-flex align-items-center justify-content-center"><small>01</small></div>
            ...
            <div class="col-md-4 text-center d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100"
                ...
                <div class="flow-wrap flow-wrap-2">
                    <div class="icon">
                        <div class="d-flex align-items-center justify-content-center"><small>02</small></div>
            ...
            <div class="col-md-4 text-center d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100"
                ...
                <div class="flow-wrap flow-wrap-left">
                    <div class="icon">
                        <div class="d-flex align-items-center justify-content-center"><small>03</small></div>
    ...
    <div class="container-xl">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-md-6 col-lg-6 d-flex">
                <div class="blog-entry justify-content-end d-md-flex" data-aos="fade-up" data-aos-duration="1000"
                     data-aos-delay="100">
            ...
            <div class="col-md-6 col-lg-6 d-flex">
                <div class="blog-entry justify-content-end d-md-flex" data-aos="fade-up" data-aos-duration="1000"
                     data-aos-delay="100">
                    <a href="blog-single.html" class="block-20 img order-lg-last"
        ...
        <div class="container-xl">
            <div class="row">
                <div class="col-md-12 text-center">
                    <p class="mb-0" style="font-size: 14px;">Copyright &copy;<script data-cfasync="false"
                                                                                     src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>
                        <script>document.write(new Date().getFullYear());</script>
                        All rights reserved | This template is made with <i class="fa fa-heart color-danger"
                                                                            aria-hidden="true"></i> by <a
                            href="https://colorlib.com/" target="_blank" rel="nofollow noopener">Colorlib</a></p>
                </div>
            </div>
        </div>
    </div>
...
<script src="js/glightbox.min.js%2baos.js.pagespeed.jc.PASSSfJlwt.js"></script>
<script>eval(mod_pagespeed_GoxUyftWQ2);</script>
<script>eval(mod_pagespeed_EpxrUfmyQz);</script>
<script src="js/datepicker.min.js%2bgoogle-map.js%2bmain.js.pagespeed.jc.USRLwWRXS3.js"></script>
<script>eval(mod_pagespeed_J_izKJnS9b);</script>
<script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&amp;sensor=false"></script>
<script>eval(mod_pagespeed_udx4xrxpoc);</script>
<script>eval(mod_pagespeed_RGbNin9rny);</script>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v64f9daad31f64f81be21cbef6184a5e31634941392597"
        ...
        data-cf-beacon='{"rayId":"6b6aef94895fdcea","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.11.0","si":100}'
...
<!-- Mirrored from preview.colorlib.com/theme/furnish/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Dec 2021 02:27:34 GMT -->
<head>
    <title>Furnish - Free Bootstrap 5 Template by Colorlib</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet"
          href="css/A.animate.css%2bflaticon.css%2btiny-slider.css%2bglightbox.min.css%2baos.css%2bdatepicker.min.css%2bstyle.css%2cMcc.9FRStqPSTJ.css.pagespeed.cf.bdTt0htMes.css"/>
</head>
<body>
